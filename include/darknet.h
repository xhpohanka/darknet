...
typedef enum {
    ...
    LETTERBOX_DATA, REGRESSION_DATA, SEGMENTATION_DATA, INSTANCE_DATA, ISEG_DATA, VIDEO_DATA, GRAYED_VIDEO_DATA
} data_type;
...
void draw_detections(image im, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int sc);
